...
export const stockEntryApiSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    addStockEntryForInward: builder.mutation({
      query: (data) => ({
        url: `${USER_URL}/addStockEntryForInward`,
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
    ...
    addStockEntryForOutward: builder.mutation({
      query: (data) => ({
        url: `${USER_URL}/addStockEntryForOutward`,
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
